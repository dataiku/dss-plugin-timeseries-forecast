...
params["evaluation_dataset"].write_with_schema(training_session.get_evaluation_metrics_df(), dropAndCreate=params["no_partitioning"])
...
if params["make_forecasts"]:
    ...
    params["evaluation_forecasts_dataset"].write_with_schema(evaluation_forecasts_df, dropAndCreate=params["no_partitioning"])
